...
$("globalStat").textContent=`${totalWords} mục từ • ${textCount} bài khóa • v11`;
...
window.openLesson=n=>{
  if (window.yuhuaRequireLogin && !window.yuhuaRequireLogin()) return;
...
function showModule(mod){
  ...
  if (window.yuhuaTrackActivity) window.yuhuaTrackActivity(currentLesson.n, mod);if(currentLesson.sourceUnavailable && mod!=="vocab") return unavailable();
