...
$("globalStat").textContent=`HSK 2: 15 bài • HSK 3: ${textCount} bài khóa • v22`;
  ...
  grid.innerHTML=data.map(l=>{
    if(selectedHSKLevel===2){
      ...
      return `<button class="lesson-card" onclick="openLesson(${l.n})">
        ...
        <div class="muted" style="margin-top:10px">Trang ${l.page} • ${wordCount?wordCount+" từ đã nhập":"ngữ pháp trọng tâm"}${textCount?` • ${textCount} bài khóa`:""}</div>
      </button>`;
    }
...
function configureHsk2Modules(){
  ...
  setModuleVisible("fill",false);
  setModuleVisible("quiz",false);
}
