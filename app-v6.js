...
$("globalStat").textContent=`${totalWords} mục từ • ${textCount} bài khóa • v6`;
...
function renderReviewCard(showBack=false){
  ...
  $("moduleContent").innerHTML=`
    <div class="exercise-wrap">
      ...
      <p class="exercise-sub">Nhìn mặt trước để nhớ nghĩa. Bấm <b>Lật thẻ</b> để xem pinyin và nghĩa tiếng Việt.</p>

      <div class="flashcard vocab-card" onclick="flipReview()">
        <div id="cardFront" class="${showBack?'hidden':''}">
          <div class="flash-label">Mặt trước</div>
          <div class="flash-hanzi">${escapeHtml(x.hanzi)}</div>
          <div class="flash-tap">Bấm để lật thẻ</div>
        </div>

        <div id="cardBack" class="${showBack?'':'hidden'}">
      ...
      <div class="controls">
        ...
        <button class="primary" onclick="flipReview()">Lật thẻ</button>
